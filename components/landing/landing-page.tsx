      ...
      <div className="relative" style={topSectionBackgroundStyle}>
        <header className="relative z-20 pt-5 sm:pt-6">
          <div className={`${containerClass} flex items-center justify-between gap-4`}>
            <a
              href="#hero"
              className="inline-flex items-center gap-3 rounded-full border border-white/70 bg-white/68 px-3 py-2 backdrop-blur"
              aria-label="ALVEA"
            >
              <img
                src="/alvea-icone.ico"
              ...
              />
              <span className="font-heading text-2xl leading-none tracking-[0.18em] text-[#8d6d2c]">
                ALVEA
              </span>
            </a>
                ...
                <div className="mt-8 grid gap-6">
                  <div className="relative overflow-hidden rounded-[1.8rem] border border-white/70 bg-[#f8efe6]">
                    ...
                    <div className="absolute inset-x-4 bottom-4 rounded-[1.4rem] border border-white/40 bg-[rgba(255,248,241,0.78)] p-4 shadow-[0_20px_40px_rgba(71,50,23,0.18)] backdrop-blur">
                      ...
                      <p className="font-heading mt-2 text-[1.8rem] leading-none font-semibold text-[#2d2418]">
                        Lavanda
                      </p>
                      <p className="mt-2 text-sm leading-6 text-[#5c4c3c]">
                        Sensação acolhedora, acabamento sofisticado e presença elegante no ambiente.
                      </p>
                    </div>
                  </div>
          ...
          <div className="relative mt-8">
            ...
            <div className="grid gap-4 lg:grid-cols-4">
              {steps.map((step, index) => (
                <article
                  key={step.title}
                  className="premium-card relative rounded-[1.8rem] p-5 pt-16 sm:p-6 sm:pt-18"
                >
                  <span className="absolute left-5 top-5 flex h-10 w-10 items-center justify-center rounded-full bg-[#2d2418] text-sm font-semibold text-white sm:left-6 sm:top-6">
                    {index + 1}
                  </span>
